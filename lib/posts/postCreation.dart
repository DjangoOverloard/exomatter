            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  !widget.inHero && titleControl.text.trim().length != 0
                      ? Padding(
                          padding: EdgeInsets.only(top: 10),
                          child: Align(
                  ...
                  widget.inHero
                      ? Column(
                          ...
                          children: [
                            ...
                            linkControl.text.trim().length != 0
                                ? Align(
                                    alignment: Alignment.centerRight,
                                    child: GestureDetector(
                                      onTap: () {
                                              ...
                                              onTap: () {
                                                MultiImagePicker.pickImages(
                                                  ...
                                                  files.forEach((g) async {
                                                    ...
                                                    final file = File(
                                                        '$temp/pic#${iterator}Date$date.jpg');
                            ...
                            AnimatedSwitcher(
                              ...
                              child: selectedTag == ''
                                  ? Wrap(
                                      ...
                                      runSpacing: 10,
                                      children: List.generate(
                                          tagDoc.data['tags'].length, (index) {
                                        return GestureDetector(
                                          onTap: () {
                                            selectedTag =
                                                tagDoc.data['tags'][index];
                                            setState(() {});
                                          },
                                          child: Container(
                                            height: 30,
